...
export default class SuperJSONCustom {
  /**
   ...
   */
  constructor({ dedupe }?: { dedupe?: boolean });
...
export declare const registerClass: (
  v: Class,
  options?: string | RegisterOptions | undefined
) => void;
export declare const registerCustom: <I, O extends JSONValue>(
  transformer: Omit<CustomTransfomer<I, O>, "name">,
  name: string
) => void;
export declare const registerSymbol: (
  v: Symbol,

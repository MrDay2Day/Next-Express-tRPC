...
declare type LeafTypeAnnotation =
...
declare type CompositeTypeAnnotation =
  | TypedArrayAnnotation
  | ClassTypeAnnotation
  | SymbolTypeAnnotation
  | CustomTypeAnnotation;
export declare type TypeAnnotation =
  | SimpleTypeAnnotation
  | CompositeTypeAnnotation;
export declare function isInstanceOfRegisteredClass(
  potentialClass: any,
  superJson: SuperJSON
...
export declare const transformValue: (
  ...
  | undefined;
export declare const untransformValue: (
  json: any,
  type: TypeAnnotation,
  superJson: SuperJSON
) => any;
